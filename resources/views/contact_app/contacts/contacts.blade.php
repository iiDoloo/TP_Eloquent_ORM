...
<div class="bg-red-400 rounded p-5 flex justify-between">
    <h1 class="text-white font-bold text-xl">All Contacts</H1>
<div class="flex">
...
<div class=" mt-5 flex items-center gap-4">
  <div class="flex-grow">
    <form action="{{ route('contacts.index') }}" method="GET">
      <label for="search" class="block text-sm font-medium text-gray-700 sr-only">Search contacts</label>
...
<a href="{{route('contacts.create')}}" class="inline-block mt-5 mb-5 rounded-sm border px-6 w-25 bg-white border-red-600 py-3 text-sm font-medium text-red-400 hover:bg-red-200 hover:text-white focus:ring-3 focus:outline-hidden" href="#">
            Ajouter
</a>
    ...
    <table class="min-w-full divide-y-2 divide-gray-200">
      ...
      >
        ...
        <td class="px-3 py-2 whitespace-nowrap">
            ...
            <a href="{{route('contacts.edit',$contact->id)}}" class="px-3 py-1.5 text-sm font-medium text-gray-700 transition-colors hover:bg-gray-50 hover:text-gray-900 focus:relative" aria-label="Edit">
